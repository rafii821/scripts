...
wait(1) 
Notification:Notify( 
    {Title = "Xiao Da", Description = "Loading"}, 
    {OutlineColor = Color3.fromRGB(80, 80, 80), Time = 5, Type = "image"}, 
    {Image = "http://www.roblox.com/asset/?id=4483345998", ImageColor = Color3.fromRGB(255, 84, 84)} 
) 
wait(2) 
Notification:Notify( 
    {Title = "Xiao Da", Description = "Ready!"}, 
    {OutlineColor = Color3.fromRGB(80, 80, 80), Time = 5, Type = "image"}, 
    {Image = "http://www.roblox.com/asset/?id=4483345998", ImageColor = Color3.fromRGB(255, 84, 84)} 
)
wait(0.2)
Notification:Notify( 
    {Title = "Xiao Da", Description = "Support the author Xiao Da"}, 
...
local win = lib:Window("Restaurant Tycoon 2", Color3.fromRGB(0, 255, 0), Enum.KeyCode.E) -- your own keybind 

local tab = win:Tab("Main")

tab:Toggle("Instant Cooking", false, function(Value)
...
tab:Toggle("Auto Collect", false, function(Value)
...
tab:Toggle("NPC Cook and Deliver", false, function(Value)
